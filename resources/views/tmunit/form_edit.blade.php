<div class="card">
    <div class="card-header">
        <div class="card-title">{{ _('Update Data Bidang') }}</div>
    </div>
    <div class="ket"></div>
    <form id="exampleValidation" method="POST" class="simpan">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control" id="kode" name="unit_kode"
                        value="{{ $unit_kode }}">
                </div>
                <label for="name" class="col-md-2 text-left">Nama Bidang <span
...
<script type="text/javascript">
    $(function() {
        $('.simpan').on('submit', function(e) {
            ...
            // alert('asa');
            $.ajax({
                url: "{{ route('master.unit.update', $id) }}",
                method: "PUT",
                data: $(this).serialize(),
                chace: false,
                async: false,
