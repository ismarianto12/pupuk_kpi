 ...
 <form class="simpan form" novalidate="">
     <div class="card-body">
         ...
         <div class="form-group">
             <label>Nama Polaritas</label>
             <div class="input-icon input-icon-right">
                 <input type="text" name="nama_polaritas" class="form-control" placeholder="Search..." required />
             </div>
 ...
 <script type="text/javascript">
     ...
     $(function() {
         $('.simpan').on('submit', function(e) {
             e.preventDefault();
             $.ajax({
                 url: "{{ route('master.polaritas.store') }}",
                 method: "POST",
                 data: $(this).serialize(),
                 chace: false,
                 async: false,
