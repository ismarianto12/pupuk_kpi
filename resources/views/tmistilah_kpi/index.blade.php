...
@section('title', 'Istilah Formula KPI')

@section('content')
@section('toolbars')
    @include('layouts.toolbars', [
        'url' => Url('pegawai/create'),
        'par' => '<i class="fa fa-list"></i> Formula dalam istilah KPI',
        'label' => 'Kembali',
        'ajax_button' => '',
    ])
@endsection
...
<script>
    ...
    function del() {
        ...
        if (c.length == 0) {
            ...
            $.post("{{ route('master.tmistilah_kpi.destroy', ':id') }}", {
                '_method': 'DELETE',
                'id': c
            }, function(data) {
    ...
    jQuery(document).ready(function() {
        ...
        $('#tambah').on('click', function() {
            ...
            addUrl = '{{ route('master.tmistilah_kpi.create') }}';
        ...
        $('#datatable').on('click', '#edit', function(e) {
            ...
            var id = $(this).data('id');
            addUrl =
                '{{ route('master.tmistilah_kpi.edit', ':id') }}'.replace(':id', id);
            $('#form_content').load(addUrl);
        });
