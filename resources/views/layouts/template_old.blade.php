        ...
        <div class="main-header">
            ...
            <div class="logo-header" data-background-color="white">
                <a href="" class="logo" style="color: #fff">
                    <img src="https://1.bp.blogspot.com/-ZJAAFa70Pns/YTidmWF0Z-I/AAAAAAAAF10/eCTtwl_qBUc_fLZClLTZ5_Q3to9GVymkQCLcBGAsYHQ/s1600/Logo%2BTelkomsel%2BTerbaru.png"
                ...
                <div class="sidebar-content">
                    ...
                    <ul class="nav nav-primary">
                        <li class="nav-item active">
                            <a data-toggle="collapse" href="{{ url('index.html') }}" class="collapsed"
                                aria-expanded="false">
            ...
            <footer class="footer" style="background: #eee">
                <div class="container-fluid">
                    ...
                    <div class="copyright ml-auto">
                        {{ date('Y') }}, Developed By : by <a href="https://kazar.co.id/" target="_blank">CV
                            Kazar
                            Teknologi Indonesia & Team
                        </a>
                    </div>
                </div>
            </footer>
