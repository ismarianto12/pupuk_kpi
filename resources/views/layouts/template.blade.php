    ...
    <head>
        ...
        <meta name="description" content="{{ Properti_app::deskripsi() }}" />
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset('assets/js/plugin/pace/') }}/pace.min.css">
    ...
    <body id="kt_body"
        ...
        <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
            <!--begin::Logo-->
            <a href="index.html">
                <img alt="Logo" src="{{ asset('assets/img/logo.png') }}" class />
            </a>
            <!--end::Logo-->
            <!--begin::Toolbar-->
                ...
                <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                    ...
                    <div class="brand flex-column-auto" id="kt_brand" style="background: #fff">
                        ...
                        <a href="index.html" class="brand-logo">
                            <img alt="Logo" src="{{ asset('assets/img/logo.png') }}" class="max-h-55px" />
                        </a>
                        <!--end::Logo-->
                        <!--begin::Toggle-->
                    ...
                    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
                            ...
                            <ul class="menu-nav">
                                @php echo Properti_app::menu_app() @endphp
                            </ul>
                        </div>
                    </div>
                    <!--end::Aside Menu-->
                            ...
                            <div class="topbar">
                                        ...
                                        <form>
                                            ...
                                            <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top"
                                                ...
                                                <h4 class="d-flex flex-center rounded-top">
                                                    <span class="text-white"> Pengajuan Kamus KPI </span>
                                                    <span
                                                        class="_____notifikasi btn btn-text btn-success btn-sm font-weight-bold btn-font-md ml-2">{loading...}</span>
                                                </h4>
                                                <!--end::Title-->
                                                <!--begin::Tabs-->
                                                <ul class="nav nav-bold nav-tabs nav-tabs-line nav-tabs-line-3x nav-tabs-line-transparent-white nav-tabs-line-active-border-success mt-3 px-8"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link active show" data-toggle="tab"
                                                            href="#topbar_notifications_events">Semua data pengajual
                                                            kpi dari unit</a>
                                                    </li>
                                                    <li class="nav-item">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <!--begin::Tabpane-->
                                                <div class="tab-pane active show" id="topbar_notifications_events"
                                                    role="tabpanel">
                                                    <!--begin::Nav-->
                                                    <div class="navi navi-hover scroll my-4" data-scroll="true"
                                                        data-height="300" data-mobile-height="200">

                                                        <div class="load_nitification"></div>
                                ...
                                <div class="topbar-item">
                                    <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2"
                                        ...
                                        @if (Auth::user()->tmlevel_id != 1)
                                            <span
                                                class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">Unit
                    ...
                    <div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
                        ...
                        <div
                            ...
                            <div class="text-dark order-2 order-md-1">
                                ...
                                <a href="http://Pupuk Indonesia.com" target="_blank"
                                    class="text-dark-75 text-hover-primary">IT Departemen Pupuk Indonesia</a>
                            </div>
        ...
        <div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
            ...
            <div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
                <h3 class="font-weight-bold m-0">Unit Korporat
            ...
            <div class="offcanvas-content pr-5 mr-n5">
                ...
                <div class="d-flex align-items-center mt-5">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="text-muted mt-1">Administrator Supert user</div>
                        <div class="navi mt-2">
                        ...
                        <div class="navi navi-icon-circle navi-spacer-x-0">
                            ...
                            <a href="#" class="navi-item">
                                <div class="navi-link rounded">
                                    ...
                                    <div class="navi-text">
                                        <div class="font-weight-bold font-size-lg">2 new items have been submited
                                        </div>
                                        <div class="text-muted">by Grog John</div>
                                    </div>
                                </div>
        ...
        <div id="kt_scrolltop" class="scrolltop">
            <span class="svg-icon">
                <img src="{{ asset('assets') }}/media/svg/icons/Navigation/Up-2.svg" />
            </span>
        </div>
        ...
        <script src="{{ asset('assets') }}/js/plugin/pace.js"></script>

        <script src="{{ asset('assets') }}/js/pages/widgets.js"></script>
        <script src="{{ asset('assets') }}/js/aplikasi.js"></script>
        <script src="{{ asset('assets') }}/plugins/custom/datatables/datatables.bundle.js"></script>
        <script src="{{ asset('assets') }}/js/plugin/datatables/dataTables.rowGroup.min.js"></script>

        <script src="{{ asset('assets') }}/plugins/custom/prismjs/prismjs.bundle.js"></script>
        <script src="{{ asset('assets') }}/plugins/custom/fullcalendar/fullcalendar.bundle.js"></script>
        <script src="{{ asset('assets/js/par.js') }}"></script>
