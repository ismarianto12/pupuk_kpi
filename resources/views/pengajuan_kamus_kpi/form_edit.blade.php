<div class="card">
    <div class="card-header">
        <h4 class="card-title"><i class="fa fa-copy"></i>Edit Data Master Kamus</h4>
        ...
        <form id="exampleValidation" method="POST" class="simpan needs-validation" novalidate="">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    ...
                    <textarea class="form-control" name="definisi" id="editor2" required>{{ $definisi }}</textarea>
                </div>
                <div class="col-md-6">
                    <label class="control-label col-md-6">Tujuan</label>
                    <textarea name="tujuan" class="form-control" id="editor3" required>{{ $tujuan }}</textarea>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <textarea class="form-control" id="editor1" name="formula_penilaian" required>{{ $formula_penilaian }}</textarea>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-md-6">
            ...
            <div class="form-group row">
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control" name="catatan" id="catatan_kpi">{{ $catatan }}</textarea>
                    </div>
                </div>

                <div class="card-footer">
                    <button type="submit" class="btn btn-primary mr-2"><i class="fa fa-save"></i>Simpan
                        data</button>
    ...
    $(function() {
        ...
        $('.simpan').on('submit', function(e) {
            ...
            if ($(this)[0].checkValidity() === false) {
                ...
                $.ajax({
                    url: "{{ route('korporat.pengajuan_kamus_kpi.update', $id) }}",
                    method: "PUT",
                    data: $(this).serialize(),
                    chace: false,
                    async: false,
