...
use App\Models\tmcabangpupuk;
use Illuminate\Http\Request;
use DataTables;
class TmcabangpupukController extends Controller
{
    /**
    ...
    public function __construct(Request $request)
    {
        ...
        $this->view = '.anak_perusahaan.';
        $this->route = 'master.anak_perusahaan.';
    } 
    public function index()
    {
        $title = 'Master data anak perusahaan';
    ...
    public function api()
    {
        $data = tmcabangpupuk::select(
            'tmcabang_pupuk.id',
            'tmcabang_pupuk.nama_cabang',
            'tmcabang_pupuk.kode',
            'tmcabang_pupuk.user_id',
            'tmcabang_pupuk.created_at',
            'tmcabang_pupuk.updated_at'  
        )->join('users', 'tmcabang_pupuk.user_id', '=', 'users.id')->get();
